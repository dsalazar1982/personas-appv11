    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('departamentos.update', ['departamento' => $departamento->depa_codi]) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="id" aria-describedby="idHelp" name="id" disabled="disable" value="{{ $departamento->depa_codi }}">
                <div id="idHelp" class="form-text">Codigo de Departamento.</div>
            </div>
            <div class="mb-3">
                <label for="departamento" class="form-label">Departamento:</label>
                <input type="text" required class="form-control" id="departamento" aria-describedby="departamentoHelp" name="departamento" placeholder="Nombre del Departamento." value="{{ $departamento->depa_nomb }}">
            </div>
            <div class="mb-3">
                <label for="pais" class="form-label">Pais:</label>
                <select class="form-select" id="pais" name="pais" required>
                    <option selected disabled value="">Selecione un Pais ...</option>
